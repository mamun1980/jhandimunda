    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='board_agent', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='board',
            name='draw_algo',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dice.draralgo'),
        ),
        migrations.AddField(
            model_name='board',
            name='game',
